...
namespace NVP.HUD
{
    public static class Menu
    {
        ...
        public static Panel ReturnCreateMenu(string title, float x, float y, List<Button> buttons, Anchor anchor = Anchor.Center, PanelSkin panelSkin = PanelSkin.Fancy, float offsetX = 0f, float offsetY = 0f)
        {
            Vector2 vector2 = new Vector2(offsetX, offsetY);
            Panel panel = new Panel(new Vector2(x, y), panelSkin, anchor, vector2);
            panel.PanelOverflowBehavior = PanelOverflowBehavior.VerticalScroll;
